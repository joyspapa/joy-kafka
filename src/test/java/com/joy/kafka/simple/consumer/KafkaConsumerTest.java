...
public class KafkaConsumerTest {
	...
	private KafkaConsumer<String, String> createConsumer() {
		...
		props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "192.168.10.57:9092,192.168.10.58:9092,192.168.10.59:9092");
		...
		consumer.subscribe(Collections.singletonList("SSG-TRK-BASE-IN-TOPIC"/*"TEST-IN-TOPIC"/*"CHJUNGLOG-IN-TOPIC"/*"STREAMS-TEST-IN-TOPIC"*/));
